...
Due to the amount of topics found in LeetCode, problems can be found in the
...
LeetCode uses a statistical system of time and space evaluation that is
different of other pages like HackerRank, and this system also varies on the
language that you use: A Java solution will be compared against other Java
solutions and so on. The complexity required in the problem will give you a
hint of what is required for the overall solution:

1. ![n or n^2](https://latex.codecogs.com/svg.latex?n),
   ![n^2](https://latex.codecogs.com/svg.latex?n^2) are the easiest to
   identify
2. For ![log n](https://latex.codecogs.com/svg.latex?logn), will typically be
   a binary search or related problem
3. ![n log n](https://latex.codecogs.com/svg.latex?nlogn) will be merge sort
   or divide-and-conquer
4. ![n!](https://latex.codecogs.com/svg.latex?n!) for factorials
5. ![2^n](https://latex.codecogs.com/svg.latex?2^n) can be identified if the
   result set happens to scale like a binary pattern, like backtracking or
   permutations in general

[Cracking the Coding Interview][ctci] has such a good section on
time/space complexities and how to figure them out.

[ctci]: /2017/03/09/cracking-the-interview-code

## Dependencies

This repo was created using Python 3 and
[PyCharm](https://www.jetbrains.com/pycharm/) IDE.

Check the [leetcode repository](https://github.com/ronelzb/leetcode/){:target="_blank"}.
